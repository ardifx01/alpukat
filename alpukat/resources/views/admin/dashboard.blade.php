...
<head>
  ...
  <title>Dinas Koperasi (Admin) </title>
    ...
    <nav id="sidebar">
      ...
      <ul id="accordionSidebar" class="list-unstyled">
        ...
        <li>
          ...
          <ul id="dropdownUnggah" class="collapse list-unstyled ">
            <li><a href="#">Unggah Berkas</a></li>
            <li><a href="#">Lihat Berkas</a></li>
          </ul>
        </li>
      ...
      <footer class="footer">
        <div class="footer__block block no-margin-bottom">
          <div class="container-fluid text-center">
            ...
            <p class="no-margin-bottom">2025 &copy; Dinas Koperasi dan UKM Kepri. Download From <a target="_blank" href="https://templateshub.net">Templates Hub</a>.</p>
          </div>
        </div>
      </footer>
    </div>
