...
<style>
  ...
  .profile-surface::after{
    ...
    background:#c2cdf2; filter: blur(2px); opacity:.22;
  }
  .profile-surface::before{ width:220px;height:220px; left:-70px; top:120px; }
  .profile-surface::after { width:180px;height:180px; right:-60px; bottom:80px; }
